...
=
\begin{cases}
1, & x \leq \dfrac{L}{4} \text{ or } x \geq \dfrac{3L}{4}, \\[6pt]
0, & \dfrac{L}{4} < x < \dfrac{3L}{4}.
\end{cases}
\]
...
\section{Finite-volume spatial discretisation}
...
\section{Discretisation final result}
